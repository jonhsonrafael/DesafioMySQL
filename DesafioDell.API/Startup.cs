...
using DesafioDell.Data;
using DesafioDell.Data.Repositories;
using DesafioDell.Data.Abstract;
using DesafioDell.API.ViewModels.Mappings;
using System.Net;
...
namespace DesafioDell.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DesafioDellContext>(options => {
                switch (useInMemoryProvider)
                {
                    ...
                    b => b.MigrationsAssembly("DesafioDell.API"));
                    break;
                }
            });
